...
function Login(){
    ...
    return(
        <div className="border w-max mt-20 m-auto p-4 flex flex-col gap-3 bg-[cadetblue] rounded-xl shadow-xl ">
            <div className="text-center font-bold text-2xl p-4 text-white">Please Enter your details : (LOGIN)</div>
            ...
            <div className="flex flex-col items-start gap-2 items-center">
                <p className="text-lg text-white font-bold">Don't have account !! <span onClick={handleNavigate} className="text-blue-800 cursor-pointer underline"> Sign up</span></p>
            </div>
